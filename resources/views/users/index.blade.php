                                    ...
                                    <table id="user-tbl" class="table shorting">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $s->nama_siswa == null ? $s->nama_wali : $s->nama_siswa }}</td>
                                                <td>{{ $s->username == null ? 'Belum di set' : $s->username }}</td>
                                                <td>{{ $s->email == null ? 'Belum di set' : $s->email}}</td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" style="">
                                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editUser{{ $s->id }}">Edit</a>
                                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#destroyUser{{ $s->id }}">Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                @endforeach
