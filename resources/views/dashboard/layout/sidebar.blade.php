        ...
        <ul class="metismenu" id="menu">
            ...
            @if (Auth::user()->role == 'admin')
                ...
                <li><a class="has-arrow " href="javascript:void(0);" >
                    ...
                    <ul >
                        <li><a href="{{ route('wali_kelas.index') }}">Daftar Wali Kelas</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow " href="javascript:void(0);" >
                    <div class="menu-icon">
                ...
                <li><a href="{{ route('nomor_surat.index') }}" class="" >
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="nav-text">Persuratan</span>
                    </a>
                </li>
            @endif
            @if (Auth::user()->role == 'admin' or Auth::user()->role == 'wali kelas')
                <li><a href="{{ route('pelanggaran.index') }}" class="" >
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" >
                ...
                <ul >
                    <li><a href="{{ route('profile.change_avatar') }}">Ganti Avatar</a></li>
