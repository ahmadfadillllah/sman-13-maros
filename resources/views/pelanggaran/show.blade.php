    ...
    <div class="container-fluid">
        <div class="row">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="heading mb-0">Daftar Pelanggaran {{ $siswa->nama_siswa }}</h4>
                <div class="d-flex align-items-center">
                    <ul class="nav nav-pills mix-chart-tab user-m-tabe" id="pills-tab" role="tablist">
                        ...
                        <a href="#" class="btn btn-primary btn-sm ms-2" data-bs-toggle="modal" data-bs-target="#insertPelanggaran">+ Tambah</a>
                                                    ...
                                                    @if (Auth::user()->role == 'admin' or Auth::user()->role == 'wali kelas')
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right" style="">
                                                                <a href="#" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#editPelanggaran{{ $p->id }}">Edit</a>
                                                                <a href="#" class="btn btn-secondary btn-sm ms-2" data-bs-toggle="modal" data-bs-target="#destroyPelanggaran{{ $p->id }}">Hapus</a>
                                                            </div>
                                                        </div>
                                                    @endif
                                                </td>
