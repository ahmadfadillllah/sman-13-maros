    ...
    <div class="container-fluid">
        <div class="row">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="heading mb-0">Siswa</h4>
                <div class="d-flex align-items-center">
                    ...
                    <a href="#" class="btn btn-primary btn-sm ms-2" data-bs-toggle="modal" data-bs-target="#insertSiswa">+ Tambah Siswa</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-use-box">
                                    <div class="crd-bx-img">
                                       <img src="{{ asset('yash/yashadmin.dexignzone.com/xhtml/profile') }}/{{ $s->user->avatar }}" class="rounded-circle" style="width:100px" alt="">
                                       <div class="active"></div>
                                    </div>
                                    <div class="card__text">
                                      <h4 class="mb-0">{{ $s->nama_siswa }}</h4>
                                      <p>{{ $s->user->email }}</p>
                                    </div>
                                    <ul class="post-pos">
                                        <li>
                                            <span class="card__info__stats">Jenis Kelamin: </span>
                                    ...
                                    <div>
                                        <a href="#" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#editSiswa{{ $s->id }}">Edit</a>
                                        <a href="#" class="btn btn-secondary btn-sm ms-2" data-bs-toggle="modal" data-bs-target="#destroySiswa{{ $s->id }}">Hapus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        {{-- <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editSiswa{{ $s->id }}">Edit</a>
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#destroySiswa{{ $s->id }}">Delete</a>
