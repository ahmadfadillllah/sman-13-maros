            ...
            @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control input-default" name="nama_siswa" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control input-default" name="nis" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control input-default" name="orang_tua" required>
                    </div>
                    <div class="mb-3">
                        <label for="">No. WhatsApp Orang Tua/Wali (harus aktif)</label>
                        <br>
                        <a href="javascript:void(0)" class="badge badge-rounded badge-outline-primary">awali dengan angka 62</a>
                        <input type="number" class="form-control input-default" name="no_wa_ortu" placeholder="62xxxxxxxxx" required>
                    </div>
                    <div class="mb-3">
